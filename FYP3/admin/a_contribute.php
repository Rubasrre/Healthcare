        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th scope="col">After Contribution</th>
            ...
            <tbody>
                <?php 
                if(isset($_GET['contributeid'])){
                    $id = $_GET['contributeid'];
                    $receipt = mysqli_query($conn,"SELECT * FROM receipt_h WHERE id_assist = '$id'");
                    while($receiptRow = mysqli_fetch_array($receipt)){
                    echo '<tr>
                        <th scope="row">'.$receiptRow['id_receipt'].'</th>
                        <td>'.$receiptRow['receipt'].'</td>
                        <td>'.$receiptRow['amount'].'</td>
                        <td>'.$receiptRow['after_contribute'].'</td>
                        <td>'.$receiptRow['assist_name'].'</td>
                        <td>
                            <button type="button" class="action">
                                <a href="view.php?viewid='.$receiptRow['id_receipt'].'">View Receipt</a>
                            </button>
                        </td>
                    </tr>';
                }
