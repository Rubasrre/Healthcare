                    ...
                    echo '<tr>
                        ...
                        <td>
                            <button type="button" class="action">
                                <a href="c_view.php?viewid='.$contributeRow['id_contribute'].'">View Details</a>
                            </button>
                            <button type="button" class="action">
                                <a href="c_contribute.php?contributeid='.$contributeRow['id_contribute'].'">Contribution</a>
                            </button>
                            <button type="button" class="action">
                                <a href="c_update.php?updateid='.$contributeRow['id_contribute'].'">Update</a>
                            </button>
                            <button type="button" class="action">
                                <a href="c_delete.php?deleteid='.$contributeRow['id_contribute'].'">Delete</a>
                            </button>
                        </td>
                    </tr>';
                }
